...
WebUI.click(findTestObject('Object Repository/Website/Page_CURA Healthcare Service/label_Apply for hospital readmission'))

WebUI.click(findTestObject('Object Repository/Website/Page_CURA Healthcare Service/input_Visit Date (Required)_visit_date'))

WebUI.setText(findTestObject('Object Repository/Website/Page_CURA Healthcare Service/textarea_Comment_comment'), 'No Comment')
